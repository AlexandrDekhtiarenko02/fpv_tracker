...
#
# PREVIEW_W / PREVIEW_H = 640x480 — точный нативный размер камеры и
# ровно высота активного режима: источник вписывается 1:1, без
# масштабирования и без letterbox вовсе.
...
#
# По ширине активный режим (ACTIVE_MODE_W=720) шире окна (640) — первая
# версия этой правки оставляла PREVIEW_X=0, и вся разница (80px) уходила
# ЦЕЛИКОМ в правый край: стенд показал это как "огромную полосу справа",
# картинка визуально уехала влево. PREVIEW_X центрирует окно по ширине —
# та же неиспользуемая площадь (80px), но поровну по обе стороны, а не
# одним куском с одного края.
ACTIVE_MODE_W = 720
