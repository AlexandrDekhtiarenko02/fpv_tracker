...
#
# ЧИСЛО ВЗЯТО ИЗ ПОЛЁТА ПО СВЕРКЕ С GPS, а не со стола.
#
# Стол давал 6.9°, и это оказалось грубо неверно. 4 сентября 2026 сделаны 12
# заходов с фиксом GPS и вписанными координатами цели: истинная дистанция
# известна на каждом кадре, значит известен и истинный угол снижения. 2584
# точки на углах от 6 до 45 градусов.
#
# Замеренный угол оказался занижен на 6.4° по медиане, и наилучший наклон
# камеры по этой выборке — 0.51°, то есть камера смотрит почти вдоль рамы.
# Ошибка дальности при этом падает втрое с лишним:
#
#     наклон 6.9°  ->  62.7% медиана, 119% на 90-м процентиле
#     наклон 0.5°  ->  17.5% медиана,  42%
#
# Почему стол ошибся: там дрон стоял на столе, цель была в трёх метрах, и
# разница высот объектива и цели в 10 см даёт уже 1.9°. Плюс сам замер шёл
# по совмещению прицела на глаз. В полёте таких допущений нет.
#
# ГДЕ ДАЛЬНОСТЬ ГОДНА после поправки (замерено по той же выборке):
#     угол 12-18°  ->  11% медиана   лучший режим
#     угол 18-45°  ->  21%
#     угол  6-12°  ->  31%           на пологих заходах доверять нельзя
CAMERA_TILT_DEG = 0.5
