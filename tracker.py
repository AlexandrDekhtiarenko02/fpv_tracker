...
#
# ЧЕГО ЭТОТ ЗАМЕР НЕ ДОКАЗЫВАЕТ. Все 46 заходов сняты в режиме наблюдения:
# рулил пилот и сам держал цель в центре, то есть компенсировал руками.
# Поэтому «выключить компенсацию совсем» дало бы в этих логах ошибку 11 px —
# но это artefact пилота, а не доказательство, что она не нужна. Нужна ли она
