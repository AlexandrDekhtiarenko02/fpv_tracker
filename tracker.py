...
# Потолок усиления, чтобы компенсация света не ушла в чистый шум.
...
def main():
    ...
    try:
        ...
        exp = min(exp_auto, MAX_EXPOSURE_US)
        # Свет, потерянный из-за укорочения выдержки, возвращаем усилением,
        # иначе картинка просто станет тёмной и трекеру будет не за что
        # цепляться.
