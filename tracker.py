...
# масштабирования и без letterbox вовсе. По ширине активный режим шире
# (720) — справа остаётся неиспользуемая полоса, не связанная с
# репортнутым симптомом (там сверху), трогать не стали.
