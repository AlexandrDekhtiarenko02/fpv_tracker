...
print("\n=== 1. RC судится по свежести связи, а не по значению по умолчанию ===")
...
print("\n=== 2. Ответ нулями — это отсутствие GPS, а не исправный GPS ===")
for opisanie, st in (
...
print("\n=== 3. Акселерометр в нулях — это не исправный акселерометр ===")
...
print("\n=== 4. Строка не исчезает НИКОГДА: отсутствие названо вслух ===")
...
print("\n=== 5. Нет на плате, но нужен — это ОТКАЗ, а не тишина ===")
...
print("\n=== 6. Нет на плате и не нужен — это не отказ ===")
...
print("\n=== 7. Полётник не прислал перечень — об этом сказано отдельно ===")
...
print("\n=== 8. Не ответил в срок — назван поимённо ===")
...
print("\n=== 9. Всё поднялось — отчёт уходит; отказ остаётся ===")
