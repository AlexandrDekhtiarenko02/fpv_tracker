...
# -1 означает: чтобы ОПУСТИТЬ нос (увеличить fc_pitch), PWM надо УМЕНЬШИТЬ.
#
# Согласовано с PITCH_SIGN = -1, который говорит то же самое с другого конца:
# цель ниже центра кадра (нужен нос вниз) даёт отрицательное смещение PWM.
# Две константы описывают один физический факт, и раньше они противоречили
# друг другу — из-за чего угловой контур разгона стоял в насыщении всегда.
#
